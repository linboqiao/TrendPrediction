...
class trainmodel(object):
    ...
    def dnn_model(self):
        # define the model
        model = Sequential([
            Dense(256, input_dim=116, kernel_regularizer=regularizers.l2(0.001), activity_regularizer=regularizers.l1(0.001)),
            Activation('relu'),
            Dropout(0.5),
    ...
    def dnn_model_best(self):
        ...
        model = Sequential([
            ...
            Dense(128, kernel_regularizer=regularizers.l2(0.001), activity_regularizer=regularizers.l1(0.001)),
            Activation('relu'),
            Dropout(0.5),

            Dense(64, kernel_regularizer=regularizers.l2(0.001), activity_regularizer=regularizers.l1(0.001)),
            Activation('relu'),
            Dropout(0.5),
    ...
    def model_fit(self, model, train_features, train_label, train_weight):
        early_stopping = EarlyStopping(monitor='acc', min_delta=0, verbose=1, patience=5)
